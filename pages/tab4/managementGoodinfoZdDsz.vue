<template>
	<view class="" v-if="goodsInfo && goodsInfo.g_info.goods_id">
		...
		<!-- <view class="fixed W_100 flex_rowR" style="bottom: 0;background-color: rgba(0,0,0,0.6);">
			<view class="PLR_3 PTB_2 B_radius_5 flex_row_around color_fff fontS_12 W_40"> -->
				...
				<!-- <view class="flex_colC PLR_1" v-if="type == 0 || type == 1" @click="upAndDowngoods">
					<image class="WH_6vw MB_1" :src="type == 0 ? img1 : img2" mode=""></image>
					<view>{{type == 0 ? '下架' : '不加价上架'}}</view>
				</view> -->
